...
public interface PersonControllerDocs {
	...
	@Operation(summary = "Exporter People",
		description = "Exporter a Page of People in XLSX and CSV Format",
		tags = {"People"},
		responses = {
			@ApiResponse(
				description = "Success",
	...
	@Operation(summary = "Exporter Person Data as PDF",
		description = "Exporter a specific Person data as PDF by your id",
		tags = {"People"},
		responses = {
			@ApiResponse(
				description = "Success",
